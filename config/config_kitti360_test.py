...
## path
path = edict()
path.data_path = "./data/train_val" # used in visualDet3D/data/.../dataset
path.test_path = "./data/testing" # used in visualDet3D/data/.../dataset
path.visualDet3D_path = "./visualDet3D" # The path should point to the inner subfolder
path.project_path = "./workdirs_test" # or other path for pickle files, checkpoints, tensorboard logging and output files.
...
data = edict(
    ...
    train_split_file = os.path.join(cfg.path.visualDet3D_path, 'data', 'kitti', 'kitti360_split', 'trainval_det.txt'),
    val_split_file   = os.path.join(cfg.path.visualDet3D_path, 'data', 'kitti', 'kitti360_split', 'test_det.txt'),
)
